...
const MANIFEST = [
  ...
  ["module/item/item-sheet.js:826", "_cpActivateArmorRestoreControl", "item-sheet:any", "click", ".cp-armor-restore", "", "renders only on a pack-sourced armor item viewed by a GM (parseCompendiumSource must resolve) — the fixture item is not one", null],
