...
const MANIFEST = [
  ...
  ["module/shop/catalog.js:692", "_activateRowChoices", "shop-catalog", "change", ".cp-catalog-ammo-load", "", null, null],
  ["module/shop/catalog.js:692", "_activateRowChoices", "shop-catalog", "change", ".cp-cat-price b", "", null, null],
  ["module/shop/catalog.js:702", "_activateRowChoices", "shop-catalog", "change", ".cp-catalog-style", "", null, null],
  ["module/shop/catalog.js:720", "_activateBuyerPick", "shop-catalog", "change", ".cp-buyer-pick", "", null, null],
  ["module/shop/catalog.js:790", "activateListeners", "shop-catalog", "click", ".cp-shop-back", "", null, null],
  ["module/shop/catalog.js:793", "activateListeners", "shop-home", "click", ".cp-home-catalog", "", null, null],
  ["module/shop/catalog.js:794", "activateListeners", "shop-storefront", "click", ".cp-shop-manage", "", null, null],
  ["module/shop/catalog.js:798", "activateListeners", "shop-home", "click", ".cp-home-shop", "shopId", null, null],
  ["module/shop/catalog.js:802", "activateListeners", "shop-home", "click", ".cp-home-create", "", null, null],
  ["module/shop/catalog.js:812", "activateListeners", "shop-home", "contextmenu", ".cp-home-shop", "shopId", null, null],
  ...
  ["module/shop/catalog.js:858", "activateListeners", "shop-catalog", "click", ".cp-cat-expand", "cat", null, null],
  ["module/shop/catalog.js:867", "activateListeners", "shop-catalog", "change", ".cp-src-toggle", "source", null, null],
  ["module/shop/catalog.js:876", "activateListeners", "shop-catalog", "click", ".cp-cat-itemname, .cp-cat-thumb", "", null, null],
  ["module/shop/catalog.js:876", "activateListeners", "shop-catalog", "click", "[data-item-id], [data-source-key]", "", null, null],
  ["module/shop/catalog.js:885", "activateListeners", "shop-catalog", "click", ".cp-catalog-buy", "", null, null],
  ["module/shop/catalog.js:885", "activateListeners", "shop-catalog", "click", "[data-ammo-caliber], [data-item-id], [data-source-key]", "ammoCaliber,curated,itemId,packId,sourceKey", null, "ANY:ammoCaliber,itemId,sourceKey"],
  ["module/shop/catalog.js:1007", "_activatePurchaseDrag", "shop-catalog", "dragstart", ".cp-catalog-list .cp-catalog-row[data-source-key]", "", null, null],
  ["module/shop/catalog.js:1052", "_activateSetupMode", "shop-build", "click", ".cp-shop-setup-toggle", "", null, null],
  ["module/shop/catalog.js:1064", "_activateCatalogShopAdd", "shop-catalog", "click", "[data-source-key]", "", null, null],
  ["module/shop/catalog.js:1088", "_openContextMenu", "shop-contextmenu", "click", "button[data-action]", "action", null, null],
  ["module/shop/catalog.js:1131", "_activateBuildControls", "shop-build", "click", ".cp-shop-add", "", null, null],
  ["module/shop/catalog.js:1132", "_activateBuildControls", "shop-build", "click", ".cp-shop-remove", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1132", "_activateBuildControls", "shop-build", "click", ".cp-bulk-add", "", null, null],
  ["module/shop/catalog.js:1132", "_activateBuildControls", "shop-build", "click", ".cp-catalog-list .cp-catalog-row[data-source-key]", "", null, null],
  ["module/shop/catalog.js:1148", "_activateBuildControls", "shop-build", "click", ".cp-vendor-clear", "", "the vendor tray's clear renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1161", "_activateBuildControls", "shop-build", "change", ".cp-shop-price", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1164", "_activateBuildControls", "shop-build", "change", ".cp-shop-stock-qty", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1172", "_activateBuildControls", "shop-build", "click", ".cp-shop-inf", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1178", "_activateBuildControls", "shop-build", "click", ".cp-stockall-apply", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1178", "_activateBuildControls", "shop-build", "click", ".cp-stockall-qty", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1185", "_activateBuildControls", "shop-build", "click", ".cp-stockall-inf", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1192", "_activateBuildControls", "shop-build", "change", ".cp-shop-style", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1192", "_activateBuildControls", "shop-build", "change", ".cp-shop-name", "", null, null],
  ["module/shop/catalog.js:1195", "_activateBuildControls", "shop-build", "change", ".cp-shop-open", "", null, null],
  ["module/shop/catalog.js:1196", "_activateBuildControls", "shop-build", "change", ".cp-shop-fullsearch", "", null, null],
  ["module/shop/catalog.js:1197", "_activateBuildControls", "shop-build", "change", ".cp-shop-discount", "", null, null],
  ["module/shop/catalog.js:1198", "_activateBuildControls", "shop-build", "change", ".cp-shop-notes", "", null, null],
  ["module/shop/catalog.js:1199", "_activateBuildControls", "shop-build", "click", ".cp-shop-announce", "", null, null],
  ["module/shop/catalog.js:1203", "_activateBuildControls", "shop-build", "click", ".cp-shop-preview", "", null, null],
  ["module/shop/catalog.js:1204", "_activateBuildControls", "shop-build", "click", ".cp-shop-delete", "", null, null],
  ["module/shop/catalog.js:1214", "_activateBuildControls", "shop-build", "dragover", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:1215", "_activateBuildControls", "shop-build", "dragleave", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:1216", "_activateBuildControls", "shop-build", "drop", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:1599", "_wireShopCardControls", "chat-card", "click", ".cp-shop-open-link", "shopId", null, null],
