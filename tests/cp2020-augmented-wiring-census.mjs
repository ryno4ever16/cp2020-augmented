...
// ═════════════════════════════════════════════════════════════════════════════════════════════
const MANIFEST = [
  ["module/actor/actor-sheet.js:254", "_cpRestoreScroll", "character-sheet", "scroll", ".sheet-body", "", null, null],
  ["module/actor/actor-sheet.js:293", "_cpActivateActorFilePickers", "character-sheet", "click", "[data-edit]", "edit", null, null],
  ["module/actor/actor-sheet.js:303", "_cpActivateActorFilePickers", "character-sheet", "click", ".netrun-icon-frame img", "", null, null],
  ["module/actor/actor-sheet.js:303", "_cpActivateActorFilePickers", "character-sheet", "click", "input[name=\"system.icon\"]", "", null, null],
  ["module/actor/actor-sheet.js:303", "_cpActivateActorFilePickers", "character-sheet", "click", ".filepicker", "", null, null],
  ["module/actor/actor-sheet.js:348", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-pill-off", "action,drug,itemId,penalty,togglePath", null, "action,drug,penalty"],
  ["module/actor/actor-sheet.js:381", "_cpActivateStatusStrip", "character-sheet", "change", "select.cp-vision-pick", "", "no vision-governing cyberware on the fixture, so the vision pick pill is never painted", null],
  ["module/actor/actor-sheet.js:390", "_cpActivateStatusStrip", "character-sheet", "change", "select.cp-fullborg-select", "", "the borg-mode select is gated on cpShowBorgToggle — no borg body or conversion state on the fixture", null],
  ["module/actor/actor-sheet.js:401", "_cpActivateStatusStrip", "character-sheet", "mousedown", ".cp-container-uninstall, .cp-group-remove, .cp-cyber-switch", "", null, null],
  ["module/actor/actor-sheet.js:409", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-cyber-switch", "itemId", null, null],
  ["module/actor/actor-sheet.js:424", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-container-uninstall", "itemId", "no cyberware nested inside a container on the fixture", null],
  ["module/actor/actor-sheet.js:438", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-group-remove", "itemId", "no container or loadout group anchor on the fixture", null],
  ["module/actor/actor-sheet.js:490", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-chassis-delete", "itemId", "no full-borg chassis on the fixture", null],
  ["module/actor/actor-sheet.js:588", "_cpActivateActorDragDrop", "character-sheet", "dragover", "[data-drop-target]", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".stat-roll", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".facedown-roll", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".recognition-roll", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".skill-roll", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".roll-initiative", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".roll-initiative-modificator", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".stun-death-save", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".roll-stun-death-modificator", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".damage", "damage", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-delete", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-edit", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-roll", "", "ORPHAN: no template in the module OR the base system paints `.item-roll`; both bind a handler for it", null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".chipware-container .chipware[data-item-id]", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".fire-weapon", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-unequip, .cp-container-uninstall, .cp-group-remove, .cp-chassis-delete", "", null, null],
  ["module/actor/actor-sheet.js:665", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-unequip, .item-delete", "", null, null],
  ["module/actor/actor-sheet.js:759", "_cpActivateBasicActorActions", "character-sheet", "contextmenu", ".rc-item-delete", "", null, null],
  ["module/actor/actor-sheet.js:1152", "_cpActivateActorFormControls", "character-sheet", "click", ".skill-level", "", null, null],
  ["module/actor/actor-sheet.js:1152", "_cpActivateActorFormControls", "character-sheet", "click", ".skill-ask-mod", "", null, null],
  ["module/actor/actor-sheet.js:1152", "_cpActivateActorFormControls", "character-sheet", "click", "[data-action=\"clear-skill-search\"], .skill-search-clear", "", null, null],
  ["module/actor/actor-sheet.js:1152", "_cpActivateActorFormControls", "character-sheet", "click", "input.skill-search", "", null, null],
  ["module/actor/actor-sheet.js:1152", "_cpActivateActorFormControls", "character-sheet", "click", ".cp-cyberlimb-repair", "zone", "no damaged cyberlimb zone on the fixture", null],
  ["module/actor/actor-sheet.js:1152", "_cpActivateActorFormControls", "character-sheet", "click", ".cp-flesh-clear", "zone", "no recorded flesh-limb injury on the fixture", null],
  ["module/actor/actor-sheet.js:1152", "_cpActivateActorFormControls", "character-sheet", "click", ".cp-flesh-set", "zone", null, null],
  ["module/actor/actor-sheet.js:1206", "_cpActivateActorFormControls", "character-sheet", "keydown", ".skill-level", "", null, null],
  ["module/actor/actor-sheet.js:1215", "_cpActivateActorFormControls", "character-sheet", "change", "input[name^=\"system.sdp.current.\"]", "", "the SDP row paints only for a figure carrying cyberlimb or borg SDP", null],
  ["module/actor/actor-sheet.js:1215", "_cpActivateActorFormControls", "character-sheet", "change", ".skill-level", "", null, null],
  ["module/actor/actor-sheet.js:1215", "_cpActivateActorFormControls", "character-sheet", "change", ".skill-sort > select, .skill-sort select", "", null, null],
  ["module/actor/actor-sheet.js:1215", "_cpActivateActorFormControls", "character-sheet", "change", ".skill-ask-mod", "", null, null],
  ["module/actor/actor-sheet.js:1215", "_cpActivateActorFormControls", "character-sheet", "change", ".roll-initiative-modificator", "", null, null],
  ["module/actor/actor-sheet.js:1215", "_cpActivateActorFormControls", "character-sheet", "change", ".roll-stun-death-modificator", "", null, null],
  ["module/actor/actor-sheet.js:1215", "_cpActivateActorFormControls", "character-sheet", "change", "input[data-edit], select[data-edit], textarea[data-edit]", "", "no data-edit field on the character sheet's rendered tabs (the item sheet carries them)", null],
  ["module/actor/actor-sheet.js:1251", "_cpActivateActorFormControls", "character-sheet", "input", "input.skill-search", "", null, null],
  ["module/actor/actor-sheet.js:1266", "_cpActivateActorFormControls", "character-sheet", "pointerdown", "[data-action=\"clear-skill-search\"], .skill-search-clear", "", null, null],
  ["module/actor/actor-sheet.js:1267", "_cpActivateActorFormControls", "character-sheet", "mousedown", "[data-action=\"clear-skill-search\"], .skill-search-clear", "", null, null],
  ["module/actor/actor-sheet.js:1339", "_cpActivateCyberwareControls", "character-sheet", "mousedown", ".item-unequip", "", null, null],
  ["module/actor/actor-sheet.js:1347", "_cpActivateCyberwareControls", "character-sheet", "click", ".item-unequip", "", null, null],
  ["module/actor/actor-sheet.js:1351", "_cpActivateCyberwareControls", "character-sheet", "change", ".anatomy-select", "", null, null],
  ["module/actor/actor-sheet.js:1351", "_cpActivateCyberwareControls", "character-sheet", "change", ".chip-toggle input[data-skill-id]", "", null, null],
  ["module/actor/actor-sheet.js:1469", "attachChipwareTooltips", "character-sheet", "mouseenter", ".chipware", "", null, null],
  ["module/actor/actor-sheet.js:1470", "attachChipwareTooltips", "character-sheet", "mouseleave", ".chipware", "", null, null],
  ["module/actor/actor-sheet.js:1578", "_cpActivateNetrunningControls", "character-sheet", "click", ".interface-skill-roll", "skillId", null, null],
  ["module/actor/actor-sheet.js:1578", "_cpActivateNetrunningControls", "character-sheet", "click", ".netrun-program .fa-edit", "", null, null],
  ["module/actor/actor-sheet.js:1578", "_cpActivateNetrunningControls", "character-sheet", "click", ".netrun-program", "", null, null],
  ["module/actor/actor-sheet.js:1578", "_cpActivateNetrunningControls", "character-sheet", "click", ".netrun-program .fa-trash", "", null, null],
  ["module/actor/actor-sheet.js:1612", "_cpActivateNetrunningControls", "character-sheet", "contextmenu", ".netrun-active-icon", "itemId", null, null],
  ["module/actor/actor-sheet.js:1697", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-apply", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:1697", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-longterm", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:1697", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-clear", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:1697", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-cure", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:1697", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-reset", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-add", "", null, null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-pay", "", "no service entry recorded on the fixture", null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-edit", "", "no service entry recorded on the fixture", null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-delete", "", "no service entry recorded on the fixture", null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp2020ae-ip-level-up", "skillId", null, null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp2020ae-ip-lock-toggle", "", null, null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".martial-action", "", null, null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-open-shop", "", "ORPHAN (deliberate): the control was removed from the sheet — templates/actor/parts/gear.hbs records the decision and notes the handler is left harmless", null],
  ["module/actor/actor-sheet.js:1745", "_cpActivateActorCustomControls", "character-sheet", "click", "[data-item-id]", "", null, null],
  ["module/actor/actor-sheet.js:2572", "_activateTabTearOff", "character-sheet", "pointerdown", ".item[data-tab]", "tab", null, null],
  ["module/actor/actor-sheet.js:2690", "_activateGearDragSort", "character-sheet", "dragstart", ".gear[data-item-id]", "itemId", null, null],
  ["module/actor/actor-sheet.js:2698", "_activateGearDragSort", "character-sheet", "dragend", ".gear[data-item-id]", "", null, null],
  ["module/actor/actor-sheet.js:2711", "_activateGearDragSort", "character-sheet", "dragover", ".gear[data-item-id]", "itemId", null, null],
  ["module/actor/actor-sheet.js:3470", "_cpSetupNotesActions", "character-sheet", "click", "[data-action=\"notes-edit\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:351", "_cpActivateCivilianControls", "vehicle-sheet", "click", ".cp-veh-source", "", null, null],
  ["module/actor/vehicle-sheet.js:351", "_cpActivateCivilianControls", "vehicle-sheet", "click", ".field.accel, .field.decel", "", null, null],
  ...
  ["module/actor/vehicle-sheet.js:507", "_onAcpaRepair", "vehicle-sheet", "click", "[data-action=\"acpaRepair\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:512", "_onReactiveReplace", "vehicle-sheet", "click", "[data-action=\"reactiveReplace\"]", "", "no reactive plating fitted on the fixture suit", null],
  ["module/actor/vehicle-sheet.js:519", "_onWeaponAdd", "vehicle-sheet", "click", "[data-action=\"weaponAdd\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:524", "_onWeaponEdit", "vehicle-sheet", "click", "[data-action=\"weaponEdit\"]", "weaponId", "no weapons mounted on the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:529", "_onWeaponDelete", "vehicle-sheet", "click", "[data-action=\"weaponDelete\"]", "weaponId", "no weapons mounted on the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:535", "_onWeaponFire", "vehicle-sheet", "click", "[data-action=\"weaponFire\"]", "weaponId", "no weapons mounted on the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:548", "_onAcpaSystemAdd", "vehicle-sheet", "click", "[data-action=\"acpaSystemAdd\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:555", "_onAcpaSystemEdit", "vehicle-sheet", "click", "[data-action=\"acpaSystemEdit\"]", "systemId", "no ACPA systems fitted on the fixture suit", null],
  ["module/actor/vehicle-sheet.js:560", "_onAcpaSystemDelete", "vehicle-sheet", "click", "[data-action=\"acpaSystemDelete\"]", "systemId", "no ACPA systems fitted on the fixture suit", null],
  ["module/actor/vehicle-sheet.js:443", "_onOccupantDisembark", "vehicle-sheet", "click", "[data-action=\"occupantDisembark\"]", "sceneId,tokenId", "no occupant aboard the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:458", "_onLayoutFront", "vehicle-sheet", "click", "[data-action=\"layoutFront\"]", "front", null, null],
  ["module/actor/vehicle-sheet.js:472", "_onLayoutCell", "vehicle-sheet", "click", "[data-action=\"layoutCell\"]", "index", null, null],
  ["module/actor/vehicle-sheet.js:491", "_onLayoutReset", "vehicle-sheet", "click", "[data-action=\"layoutReset\"]", "", null, null],
  ...
  ["module/shop/catalog.js:537", "_activateRowChoices", "shop-catalog", "change", ".cp-catalog-ammo-load", "", null, null],
  ["module/shop/catalog.js:537", "_activateRowChoices", "shop-catalog", "change", ".cp-cat-price b", "", null, null],
  ["module/shop/catalog.js:547", "_activateRowChoices", "shop-catalog", "change", ".cp-catalog-style", "", null, null],
  ["module/shop/catalog.js:565", "_activateBuyerPick", "shop-catalog", "change", ".cp-buyer-pick", "", null, null],
  ["module/shop/catalog.js:626", "activateListeners", "shop-catalog", "click", ".cp-shop-back", "", null, null],
  ["module/shop/catalog.js:629", "activateListeners", "shop-home", "click", ".cp-home-catalog", "", null, null],
  ["module/shop/catalog.js:630", "activateListeners", "shop-storefront", "click", ".cp-shop-manage", "", null, null],
  ["module/shop/catalog.js:634", "activateListeners", "shop-home", "click", ".cp-home-shop", "shopId", null, null],
  ["module/shop/catalog.js:638", "activateListeners", "shop-home", "click", ".cp-home-create", "", null, null],
  ["module/shop/catalog.js:648", "activateListeners", "shop-home", "contextmenu", ".cp-home-shop", "shopId", null, null],
  ["module/shop/catalog.js:651", "activateListeners", "shop-catalog", "input", ".cp-catalog-search", "", null, null],
  ["module/shop/catalog.js:655", "activateListeners", "shop-catalog", "change", ".cp-catalog-showsource", "", null, null],
  ["module/shop/catalog.js:659", "activateListeners", "shop-catalog", "click", ".cp-cat-chip", "cat", null, null],
  ["module/shop/catalog.js:659", "activateListeners", "shop-catalog", "click", ".cp-cat-clear", "", null, null],
  ["module/shop/catalog.js:661", "activateListeners", "shop-catalog", "click", ".cp-jump", "letter", null, null],
  ["module/shop/catalog.js:664", "activateListeners", "shop-catalog", "click", ".cp-book-chip", "book", null, null],
  ["module/shop/catalog.js:664", "activateListeners", "shop-catalog", "click", ".cp-book-clear", "", null, null],
  ["module/shop/catalog.js:668", "activateListeners", "shop-catalog", "change", ".cp-src-toggle", "source", null, null],
  ["module/shop/catalog.js:677", "activateListeners", "shop-catalog", "click", ".cp-cat-itemname, .cp-cat-thumb", "", null, null],
  ["module/shop/catalog.js:677", "activateListeners", "shop-catalog", "click", "[data-item-id], [data-source-key]", "", null, null],
  ["module/shop/catalog.js:686", "activateListeners", "shop-catalog", "click", ".cp-catalog-buy", "", null, null],
  ["module/shop/catalog.js:686", "activateListeners", "shop-catalog", "click", "[data-ammo-caliber], [data-item-id], [data-source-key]", "ammoCaliber,curated,itemId,packId,sourceKey", null, "ANY:ammoCaliber,itemId,sourceKey"],
  ["module/shop/catalog.js:727", "_activatePurchaseDrag", "shop-catalog", "dragstart", ".cp-catalog-list .cp-catalog-row[data-source-key]", "", null, null],
  ["module/shop/catalog.js:772", "_activateSetupMode", "shop-build", "click", ".cp-shop-setup-toggle", "", null, null],
  ["module/shop/catalog.js:784", "_activateCatalogShopAdd", "shop-catalog", "click", "[data-source-key]", "", null, null],
  ["module/shop/catalog.js:808", "_openContextMenu", "shop-contextmenu", "click", "button[data-action]", "action", null, null],
  ["module/shop/catalog.js:851", "_activateBuildControls", "shop-build", "click", ".cp-shop-add", "", null, null],
  ["module/shop/catalog.js:852", "_activateBuildControls", "shop-build", "click", ".cp-shop-remove", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:852", "_activateBuildControls", "shop-build", "click", ".cp-bulk-add", "", null, null],
  ["module/shop/catalog.js:852", "_activateBuildControls", "shop-build", "click", ".cp-catalog-list .cp-catalog-row[data-source-key]", "", null, null],
  ["module/shop/catalog.js:868", "_activateBuildControls", "shop-build", "click", ".cp-vendor-clear", "", "the vendor tray's clear renders only for a shop holding lines", null],
  ["module/shop/catalog.js:881", "_activateBuildControls", "shop-build", "change", ".cp-shop-price", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:884", "_activateBuildControls", "shop-build", "change", ".cp-shop-stock-qty", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:892", "_activateBuildControls", "shop-build", "click", ".cp-shop-inf", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:898", "_activateBuildControls", "shop-build", "click", ".cp-stockall-apply", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:898", "_activateBuildControls", "shop-build", "click", ".cp-stockall-qty", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:905", "_activateBuildControls", "shop-build", "click", ".cp-stockall-inf", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:912", "_activateBuildControls", "shop-build", "change", ".cp-shop-style", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:912", "_activateBuildControls", "shop-build", "change", ".cp-shop-name", "", null, null],
  ["module/shop/catalog.js:915", "_activateBuildControls", "shop-build", "change", ".cp-shop-open", "", null, null],
  ["module/shop/catalog.js:916", "_activateBuildControls", "shop-build", "change", ".cp-shop-fullsearch", "", null, null],
  ["module/shop/catalog.js:917", "_activateBuildControls", "shop-build", "change", ".cp-shop-discount", "", null, null],
  ["module/shop/catalog.js:918", "_activateBuildControls", "shop-build", "change", ".cp-shop-notes", "", null, null],
  ["module/shop/catalog.js:919", "_activateBuildControls", "shop-build", "click", ".cp-shop-publish", "", null, null],
  ["module/shop/catalog.js:920", "_activateBuildControls", "shop-build", "click", ".cp-shop-preview", "", null, null],
  ["module/shop/catalog.js:921", "_activateBuildControls", "shop-build", "click", ".cp-shop-delete", "", null, null],
  ["module/shop/catalog.js:931", "_activateBuildControls", "shop-build", "dragover", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:932", "_activateBuildControls", "shop-build", "dragleave", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:933", "_activateBuildControls", "shop-build", "drop", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:1300", "_wireShopCardControls", "chat-card", "click", ".cp-shop-open-link", "shopId", null, null],
  ["module/shop/catalog.js:1307", "_wireShopCardControls", "chat-card", "click", ".cp-shop-request-btn", "action", null, null],
  ["module/shop/catalog.js:1307", "_wireShopCardControls", "chat-card", "click", ".cp-shop-request", "", null, null],
  ["module/shop/catalog.js:1307", "_wireShopCardControls", "chat-card", "click", ".cp-shop-request-price", "", null, null],
  ...
  ["module/item/item-sheet.js:806", "_cpActivateMechConsumableControls", "item-sheet:consumable", "click", ".cp-chip-choice-reset", "", "renders only for a chipware item holding a recorded choice", null],
  ["module/item/item-sheet.js:835", "_cpActivateVehicleDeployControls", "item-sheet:vehicle", "click", ".cp-vehicle-open", "actorId", "the open control renders only once the vehicle item has a deployed actor", null],
  ["module/item/item-sheet.js:835", "_cpActivateVehicleDeployControls", "item-sheet:vehicle", "click", ".cp-vehicle-deploy", "", "the deploy control is gated on the vehicle feature setting", null],
  ["module/item/item-sheet.js:925", "_cpActivateTabs", "item-sheet:any", "click", ".sheet-tabs", "", null, null],
  ["module/item/item-sheet.js:925", "_cpActivateTabs", "item-sheet:any", "click", "[data-tab]", "tab", null, null],
  ["module/item/item-sheet.js:979", "_cpActivateBasicItemActions", "item-sheet:any", "click", ".item-roll", "", "ORPHAN: no template in the module OR the base system paints `.item-roll`; both bind a handler for it", null],
  ["module/item/item-sheet.js:979", "_cpActivateBasicItemActions", "item-sheet:any", "click", ".humanity-cost-roll", "", "renders on a cyberware item's settings tab, not on the weapon sheet this surface opens", null],
  ["module/item/item-sheet.js:1218", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-stat", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1218", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-check", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1218", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-location", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1218", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-penalty", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1218", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-mountpolicy", "", "ORPHAN: the MountPolicy add control is bound and its list read and written, but no template paints it", null],
  ["module/item/item-sheet.js:1220", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-stat", "", "renders per recorded stat entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1220", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-check", "", "renders per recorded check entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1220", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-skill", "", "renders per recorded skill entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1220", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-location", "", "renders per recorded location entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1220", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-penalty", "", "renders per recorded penalty entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1220", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-mount", "", "ORPHAN: the MountPolicy remove control is bound, but no template paints it", null],
  ["module/item/item-sheet.js:1392", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "click", ".cw-ms-trigger", "", null, null],
  ["module/item/item-sheet.js:1392", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "click", ".cw-ms", "", null, null],
  ["module/item/item-sheet.js:1392", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "click", ".cw-ms-menu", "", null, null],
  ["module/item/item-sheet.js:1394", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", ".cw-ms-menu input[type='checkbox']", "", null, null],
  ["module/item/item-sheet.js:1394", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", ".cw-ms", "path", null, null],
  ["module/item/item-sheet.js:1394", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", ".cw-ms-menu", "", null, null],
  ["module/item/item-sheet.js:1394", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", "input[type='checkbox']:checked", "", null, null],
  ["module/item/item-sheet.js:1394", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", "input[value=\"Descriptive\"]", "", null, null],
  ["module/item/item-sheet.js:1550", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "input", "input[name='cw-skill-search'], input[name='cw-chip-skill-search']", "", "the skill-search boxes render only inside the cyberware mechanics editor (needs a chosen cyberwareType)", null],
  ["module/item/item-sheet.js:1552", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "change", "input[name='cw-skill-search'], input[name='cw-chip-skill-search']", "", "the skill-search boxes render only inside the cyberware mechanics editor (needs a chosen cyberwareType)", null],
  ["module/item/item-sheet.js:1553", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "mousedown", "input[name='cw-skill-search'], input[name='cw-chip-skill-search']", "", "the skill-search boxes render only inside the cyberware mechanics editor (needs a chosen cyberwareType)", null],
  ["module/item/item-sheet.js:1554", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "click", ".cw-remove-chipskill", "key", "renders per recorded ChipSkills entry", null],
  ["module/item/item-sheet.js:1838", "_cpActivateSkillItemControls", "item-sheet:skill", "change", "input[name=\"system.level\"], input[name=\"system.chipLevel\"], input[name=\"system.isChipped\"]", "", null, null],
  ["module/item/item-sheet.js:2030", "_cpActivateNumericCommaInputs", "item-sheet:any", "change", "input[type=\"number\"]", "", null, null],
  ["module/item/item-sheet.js:2049", "_cpActivateCyberwareInstall", "item-sheet:cyberware", "click", ".cyber-install", "", "the install control renders only for cyberware held by an actor with an install target", null],
  ["module/item/item-sheet.js:2076", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "click", ".cp-sv-add", "", null, null],
  ["module/item/item-sheet.js:2076", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "click", ".cp-sv-remove", "index", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/item-sheet.js:2104", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "change", ".cp-sv", "field", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/item-sheet.js:2104", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "change", ".cp-shellvar", "", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/item-sheet.js:2127", "_cpActivateAmmoControls", "item-sheet:ammo", "change", "input.ammo-blast-mult", "index", "the blast-multiplier row renders only for blast-capable ammo", null],
  ["module/item/item-sheet.js:2127", "_cpActivateAmmoControls", "item-sheet:ammo", "change", "select.cp-ammo-modifier", "", null, null],
  ["module/item/item-sheet.js:2127", "_cpActivateAmmoControls", "item-sheet:ammo", "change", ".ammo-ms-menu input[type=checkbox]", "", null, null],
  ["module/item/item-sheet.js:2127", "_cpActivateAmmoControls", "item-sheet:ammo", "change", ".ammo-ms", "", null, null],
  ["module/item/item-sheet.js:2127", "_cpActivateAmmoControls", "item-sheet:ammo", "change", ".ammo-ms-menu", "", null, null],
  ["module/item/item-sheet.js:2127", "_cpActivateAmmoControls", "item-sheet:ammo", "change", "input[type=checkbox]:checked", "", null, null],
  ["module/item/item-sheet.js:2127", "_cpActivateAmmoControls", "item-sheet:ammo", "change", "input[value=\"None\"]", "", null, null],
  ["module/item/item-sheet.js:2211", "_cpActivateAmmoControls", "item-sheet:ammo", "click", ".cp-ammo-qty-lock", "", null, null],
  ["module/item/item-sheet.js:2211", "_cpActivateAmmoControls", "item-sheet:ammo", "click", ".cp-ammo-buy-box", "", null, null],
  ["module/item/item-sheet.js:2211", "_cpActivateAmmoControls", "item-sheet:ammo", "click", ".ammo-ms-trigger", "", null, null],
  ["module/item/item-sheet.js:2211", "_cpActivateAmmoControls", "item-sheet:ammo", "click", ".ammo-ms", "", null, null],
  ["module/item/item-sheet.js:2339", "_cpSetupNotesActions", "item-sheet:any", "click", "[data-action=\"notes-edit\"]", "", null, null],
  ["module/item/augmented-item-sheet.js:59", "_onRender", "item-sheet:vehicleweapon", "change", "input[type=\"number\"]", "", null, null],
  ["module/item/augmented-item-sheet.js:74", "_bindShellVariants", "item-sheet:vehicleweapon", "click", ".cp-sv-add", "", null, null],
  ["module/item/augmented-item-sheet.js:83", "_bindShellVariants", "item-sheet:vehicleweapon", "click", ".cp-sv-remove", "index", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/augmented-item-sheet.js:95", "_bindShellVariants", "item-sheet:vehicleweapon", "change", ".cp-sv", "field", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/augmented-item-sheet.js:95", "_bindShellVariants", "item-sheet:vehicleweapon", "change", ".cp-shellvar", "", "shell-variant rows render only for a weapon that defines shell variants", null],
  ...
  ["module/combat/DamageDialog.js:210", "_onRender", "dialog:damage", "change", "select[name='armorMode']", "", null, null],
  ["module/combat/DamageDialog.js:216", "_onRender", "dialog:damage", "change", "select[name='damageType']", "", null, null],
  ["module/combat/DamageDialog.js:222", "_onRender", "dialog:damage", "change", "input[name='coverSP']", "", null, null],
  ["module/combat/DamageDialog.js:229", "_onRender", "dialog:damage", "change", "input[name='ablate']", "", null, null],
  ...
  ["module/vehicle/vehicle-aboard-banner.js:43", "_syncBanner", "character-sheet", "click", ".cp-aboard-out", "", "the fixture is not aboard a vehicle, so no aboard banner is injected", null],
  ["module/vehicle/vehicle-acpa-combat.js:160", "openAcpaMeleeDialog", "dialog:acpa-melee", "change", "#cp-am-skillkind", "", null, null],
  ["module/vehicle/vehicle-acpa-combat.js:162", "openAcpaMeleeDialog", "dialog:acpa-melee", "input", "#cp-am-skill", "", null, null],
];
...
const MANUAL_REVIEW = [
  ...
  ["module/shop/catalog.js:661","activateListeners","shop-catalog","selector built from a template literal"],
  ["module/shop/catalog.js:1261","injectSidebarShopButton","sidebar","addEventListener(\"click\") on `btn` — no literal selector at the registration"],
...
const NON_DOM = [
  ...
  ["module/shop/catalog.js:813","doc.addEventListener(\"click\") — gesture continuation","setTimeout"],
  ["module/shop/catalog.js:1348","Hooks.on(\"renderSidebar\")","registerShopHooks"],
  ["module/shop/catalog.js:1358","Hooks.on(\"controlToken\")","registerShopHooks"],
  ["module/shop/catalog.js:1377","game.socket.on(\"module.cp2020-augmented\")","onChatCardRender"],
  ["module/shop/catalog.js:1384","Hooks.on(\"dropActorSheetData\")","onChatCardRender"],
...
try {
  census = await p.evaluate(async ({ manifest, rendered }) => {
    ...
    try {
      ...
      await open("shop-catalog", async () => { CAT.openCatalogBrowser(pc); return shopRoot(".cp-catalog-buy, .cp-catalog-row"); }, 400);
