...
//              `field@sel` = the handler reads it off `target.closest(sel)` instead, and the census
//              measures it on that ancestor (an actions-map button whose row carries the id).
...
// ═════════════════════════════════════════════════════════════════════════════════════════════
const MANIFEST = [
  ["module/actor/actor-sheet.js:289", "_cpRestoreScroll", "character-sheet", "scroll", ".sheet-body", "", null, null],
  ["module/actor/actor-sheet.js:328", "_cpActivateActorFilePickers", "character-sheet", "click", "[data-edit]", "edit", null, null],
  ["module/actor/actor-sheet.js:338", "_cpActivateActorFilePickers", "character-sheet", "click", ".netrun-icon-frame img", "", null, null],
  ["module/actor/actor-sheet.js:338", "_cpActivateActorFilePickers", "character-sheet", "click", "input[name=\"system.icon\"]", "", null, null],
  ["module/actor/actor-sheet.js:338", "_cpActivateActorFilePickers", "character-sheet", "click", ".filepicker", "", null, null],
  ["module/actor/actor-sheet.js:383", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-pill-off", "action,drug,itemId,penalty,togglePath", null, "action,drug,penalty"],
  ["module/actor/actor-sheet.js:416", "_cpActivateStatusStrip", "character-sheet", "change", "select.cp-vision-pick", "", "no vision-governing cyberware on the fixture, so the vision pick pill is never painted", null],
  ["module/actor/actor-sheet.js:425", "_cpActivateStatusStrip", "character-sheet", "change", "select.cp-fullborg-select", "", "the borg-mode select is gated on cpShowBorgToggle — no borg body or conversion state on the fixture", null],
  ["module/actor/actor-sheet.js:436", "_cpActivateStatusStrip", "character-sheet", "mousedown", ".cp-container-uninstall, .cp-group-remove, .cp-cyber-switch", "", null, null],
  ["module/actor/actor-sheet.js:444", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-cyber-switch", "itemId", null, null],
  ["module/actor/actor-sheet.js:460", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-container-uninstall", "itemId", "no cyberware nested inside a container on the fixture", null],
  ["module/actor/actor-sheet.js:474", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-group-remove", "itemId", "no container or loadout group anchor on the fixture", null],
  ["module/actor/actor-sheet.js:526", "_cpActivateStatusStrip", "character-sheet", "click", ".cp-chassis-delete", "itemId", "no full-borg chassis on the fixture", null],
  ["module/actor/actor-sheet.js:624", "_cpActivateActorDragDrop", "character-sheet", "dragover", "[data-drop-target]", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".stat-roll", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".facedown-roll", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".recognition-roll", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".skill-roll", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".roll-initiative .action", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".roll-initiative-modificator", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".stun-death-save .action", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".roll-stun-death-modificator", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".damage", "damage", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-delete", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-edit", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-roll", "", "ORPHAN: no template in the module OR the base system paints `.item-roll`; both bind a handler for it", null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".chipware-container .chipware[data-item-id]", "", null, null],
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".fire-weapon", "", null, null],
  ...
  ["module/actor/actor-sheet.js:701", "_cpActivateBasicActorActions", "character-sheet", "click", ".item-unequip, .item-delete", "", null, null],
  ["module/actor/actor-sheet.js:797", "_cpActivateBasicActorActions", "character-sheet", "contextmenu", ".rc-item-delete", "", null, null],
  ["module/actor/actor-sheet.js:1422", "_cpActivateActorFormControls", "character-sheet", "click", ".skill-level", "", null, null],
  ["module/actor/actor-sheet.js:1422", "_cpActivateActorFormControls", "character-sheet", "click", ".skill-ask-mod", "", null, null],
  ["module/actor/actor-sheet.js:1422", "_cpActivateActorFormControls", "character-sheet", "click", "[data-action=\"clear-skill-search\"], .skill-search-clear", "", null, null],
  ["module/actor/actor-sheet.js:1422", "_cpActivateActorFormControls", "character-sheet", "click", "input.skill-search", "", null, null],
  ["module/actor/actor-sheet.js:1422", "_cpActivateActorFormControls", "character-sheet", "click", ".cp-cyberlimb-repair", "zone", "no damaged cyberlimb zone on the fixture", null],
  ["module/actor/actor-sheet.js:1422", "_cpActivateActorFormControls", "character-sheet", "click", ".cp-flesh-clear", "zone", "no recorded flesh-limb injury on the fixture", null],
  ["module/actor/actor-sheet.js:1422", "_cpActivateActorFormControls", "character-sheet", "click", ".cp-flesh-set", "zone", null, null],
  ["module/actor/actor-sheet.js:1476", "_cpActivateActorFormControls", "character-sheet", "keydown", ".skill-level", "", null, null],
  ["module/actor/actor-sheet.js:1485", "_cpActivateActorFormControls", "character-sheet", "change", "input[name^=\"system.sdp.current.\"]", "", "the SDP row paints only for a figure carrying cyberlimb or borg SDP", null],
  ["module/actor/actor-sheet.js:1485", "_cpActivateActorFormControls", "character-sheet", "change", ".skill-level", "", null, null],
  ["module/actor/actor-sheet.js:1485", "_cpActivateActorFormControls", "character-sheet", "change", ".skill-sort > select, .skill-sort select", "", null, null],
  ["module/actor/actor-sheet.js:1485", "_cpActivateActorFormControls", "character-sheet", "change", ".skill-ask-mod", "", null, null],
  ["module/actor/actor-sheet.js:1485", "_cpActivateActorFormControls", "character-sheet", "change", ".roll-initiative-modificator", "", null, null],
  ["module/actor/actor-sheet.js:1485", "_cpActivateActorFormControls", "character-sheet", "change", ".roll-stun-death-modificator", "", null, null],
  ["module/actor/actor-sheet.js:1485", "_cpActivateActorFormControls", "character-sheet", "change", "input[data-edit], select[data-edit], textarea[data-edit]", "", "no data-edit field on the character sheet's rendered tabs (the item sheet carries them)", null],
  ["module/actor/actor-sheet.js:1529", "_cpActivateActorFormControls", "character-sheet", "input", "input.skill-search", "", null, null],
  ["module/actor/actor-sheet.js:1544", "_cpActivateActorFormControls", "character-sheet", "pointerdown", "[data-action=\"clear-skill-search\"], .skill-search-clear", "", null, null],
  ["module/actor/actor-sheet.js:1545", "_cpActivateActorFormControls", "character-sheet", "mousedown", "[data-action=\"clear-skill-search\"], .skill-search-clear", "", null, null],
  ["module/actor/actor-sheet.js:1626", "_cpActivateCyberwareControls", "character-sheet", "mousedown", ".item-unequip", "", null, null],
  ["module/actor/actor-sheet.js:1634", "_cpActivateCyberwareControls", "character-sheet", "click", ".item-unequip", "", null, null],
  ["module/actor/actor-sheet.js:1638", "_cpActivateCyberwareControls", "character-sheet", "change", ".anatomy-select", "", null, null],
  ["module/actor/actor-sheet.js:1638", "_cpActivateCyberwareControls", "character-sheet", "change", ".chip-toggle input[data-skill-id]", "", null, null],
  ["module/actor/actor-sheet.js:1756", "attachChipwareTooltips", "character-sheet", "mouseenter", ".chipware", "", null, null],
  ["module/actor/actor-sheet.js:1757", "attachChipwareTooltips", "character-sheet", "mouseleave", ".chipware", "", null, null],
  ["module/actor/actor-sheet.js:1879", "_cpActivateNetrunningControls", "character-sheet", "click", ".interface-skill-roll", "skillId", null, null],
  ["module/actor/actor-sheet.js:1879", "_cpActivateNetrunningControls", "character-sheet", "click", ".netrun-program .fa-edit", "", null, null],
  ["module/actor/actor-sheet.js:1879", "_cpActivateNetrunningControls", "character-sheet", "click", ".netrun-program", "", null, null],
  ["module/actor/actor-sheet.js:1879", "_cpActivateNetrunningControls", "character-sheet", "click", ".netrun-program .fa-trash", "", null, null],
  ["module/actor/actor-sheet.js:1913", "_cpActivateNetrunningControls", "character-sheet", "contextmenu", ".netrun-active-icon", "itemId", null, null],
  ["module/actor/actor-sheet.js:2010", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-apply", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:2010", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-longterm", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:2010", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-clear", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:2010", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-cure", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:2010", "_cpActivateRadiationControls", "character-sheet", "click", ".cp-rad-reset", "", "the radiation panel renders only while the radiation feature is switched on", null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-add", "", null, null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-pay", "", "no service entry recorded on the fixture", null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-edit", "", "no service entry recorded on the fixture", null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-service-delete", "", "no service entry recorded on the fixture", null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp2020ae-ip-level-up", "skillId", null, null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp2020ae-ip-lock-toggle", "", null, null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".martial-action", "", null, null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", ".cp-open-shop", "", "ORPHAN (deliberate): the control was removed from the sheet — templates/actor/parts/gear.hbs records the decision and notes the handler is left harmless", null],
  ["module/actor/actor-sheet.js:2058", "_cpActivateActorCustomControls", "character-sheet", "click", "[data-item-id]", "", null, null],
  ["module/actor/actor-sheet.js:2989", "_activateTabTearOff", "character-sheet", "pointerdown", ".item[data-tab]", "tab", null, null],
  ["module/actor/actor-sheet.js:3107", "_activateGearDragSort", "character-sheet", "dragstart", ".gear[data-item-id]", "itemId", null, null],
  ["module/actor/actor-sheet.js:3115", "_activateGearDragSort", "character-sheet", "dragend", ".gear[data-item-id]", "", null, null],
  ["module/actor/actor-sheet.js:3128", "_activateGearDragSort", "character-sheet", "dragover", ".gear[data-item-id]", "itemId", null, null],
  ["module/actor/actor-sheet.js:3887", "_cpSetupNotesActions", "character-sheet", "click", "[data-action=\"notes-edit\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:464", "_cpActivateFaceSelect", "vehicle-sheet", "change", "select.cp-veh-face-select", "faceCurrent", null, null],
  ["module/actor/vehicle-sheet.js:496", "_cpActivateCivilianControls", "vehicle-sheet", "click", ".cp-veh-source", "", null, null],
  ["module/actor/vehicle-sheet.js:496", "_cpActivateCivilianControls", "vehicle-sheet", "click", ".field.accel, .field.decel", "", null, null],
  ["module/actor/vehicle-sheet.js:527", "_cpActivateCountermeasures", "vehicle-sheet", "change", "input.cp-cm-box", "", null, null],
  ["module/actor/vehicle-sheet.js:527", "_cpActivateCountermeasures", "vehicle-sheet", "change", "input.cp-cm-box:checked", "", "`:checked` is a live-state selector — no countermeasure box is ticked on the fixture", null],
  ["module/actor/vehicle-sheet.js:545", "_cpActivateAcpaMode", "vehicle-sheet", "change", "select[name='system.acpaCombatModel']", "", null, null],
  ["module/actor/vehicle-sheet.js:582", "_onControlRoll", "vehicle-sheet", "click", "[data-action=\"controlRoll\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:642", "_onVehicleDamage", "vehicle-sheet", "click", "[data-action=\"vehicleDamage\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:647", "_onAcpaMelee", "vehicle-sheet", "click", "[data-action=\"acpaMelee\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:652", "_onAcpaRepair", "vehicle-sheet", "click", "[data-action=\"acpaRepair\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:657", "_onReactiveReplace", "vehicle-sheet", "click", "[data-action=\"reactiveReplace\"]", "", "no reactive plating fitted on the fixture suit", null],
  ["module/actor/vehicle-sheet.js:664", "_onWeaponAdd", "vehicle-sheet", "click", "[data-action=\"weaponAdd\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:669", "_onWeaponEdit", "vehicle-sheet", "click", "[data-action=\"weaponEdit\"]", "weaponId", "no weapons mounted on the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:674", "_onWeaponDelete", "vehicle-sheet", "click", "[data-action=\"weaponDelete\"]", "weaponId", "no weapons mounted on the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:680", "_onWeaponFire", "vehicle-sheet", "click", "[data-action=\"weaponFire\"]", "weaponId", "no weapons mounted on the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:693", "_onAcpaSystemAdd", "vehicle-sheet", "click", "[data-action=\"acpaSystemAdd\"]", "", null, null],
  ["module/actor/vehicle-sheet.js:700", "_onAcpaSystemEdit", "vehicle-sheet", "click", "[data-action=\"acpaSystemEdit\"]", "systemId", "no ACPA systems fitted on the fixture suit", null],
  ["module/actor/vehicle-sheet.js:705", "_onAcpaSystemDelete", "vehicle-sheet", "click", "[data-action=\"acpaSystemDelete\"]", "systemId", "no ACPA systems fitted on the fixture suit", null],
  ["module/actor/vehicle-sheet.js:588", "_onOccupantDisembark", "vehicle-sheet", "click", "[data-action=\"occupantDisembark\"]", "sceneId,tokenId", "no occupant aboard the fixture vehicle", null],
  ["module/actor/vehicle-sheet.js:603", "_onLayoutFront", "vehicle-sheet", "click", "[data-action=\"layoutFront\"]", "front", null, null],
  ["module/actor/vehicle-sheet.js:617", "_onLayoutCell", "vehicle-sheet", "click", "[data-action=\"layoutCell\"]", "index", null, null],
  ["module/actor/vehicle-sheet.js:636", "_onLayoutReset", "vehicle-sheet", "click", "[data-action=\"layoutReset\"]", "", null, null],
  ["module/npcgen/npcgen-app.js:435", "_onRender", "goon-factory", "change", ".cp-goon-grade, .cp-goon-role, .cp-goon-outfit, .cp-goon-disposition, .cp-goon-count, .cp-goon-dest", "", null, null],
  ["module/npcgen/npcgen-app.js:446", "_onRender", "goon-factory", "input", ".cp-goon-row", "", null, null],
  ["module/npcgen/npcgen-app.js:446", "_onRender", "goon-factory", "input", ".cp-goon-dials input[type='range']", "", null, null],
  ...
  ["module/npcgen/npcgen-app.js:799", "injectNpcGenButton", "actor-directory", "click", ".cp2020ae-npcgen-btn", "", null, null],
  ["module/npcgen/npcgen-app.js:697", "_onAdvanced", "goon-factory", "click", "[data-action=\"goonAdvanced\"]", "", null, null],
  ["module/npcgen/npcgen-app.js:704", "_onGenerate", "goon-factory", "click", "[data-action=\"goonGenerate\"]", "", null, null],
  ["module/npcgen/npcgen-app.js:713", "_onConfirm", "goon-factory", "click", "[data-action=\"goonConfirm\"]", "", "a COMPUTED action key: the go-button paints data-action=\"{{generateAction}}\", which is this key only once a batch is previewed", null],
  ["module/npcgen/npcgen-app.js:727", "_onDiscard", "goon-factory", "click", "[data-action=\"goonDiscard\"]", "", "the preview strip renders only while a generated batch is held — the fixture's Generate click did not settle one", null],
  ["module/npcgen/npcgen-app.js:740", "_onRerollOne", "goon-factory", "click", "[data-action=\"goonRerollOne\"]", "index", "the preview strip renders only while a generated batch is held — the fixture's Generate click did not settle one", null],
  ["module/npcgen/npcgen-app.js:762", "_onDeleteOne", "goon-factory", "click", "[data-action=\"goonDeleteOne\"]", "index", "the preview strip renders only while a generated batch is held — the fixture's Generate click did not settle one", null],
  ["module/npcgen/npcgen-app.js:704", "_onGenerate", "goon-factory", "click", "[data-action=\"goonPickDestination\"]", "", "a COMPUTED action key: the go-button paints data-action=\"{{generateAction}}\", which is this key only while a destination is still unpicked", null],
  ["module/shop/catalog.js:873", "_activateRowChoices", "shop-catalog", "input", ".cp-catalog-qty", "", null, null],
  ["module/shop/catalog.js:886", "_activateRowChoices", "shop-catalog", "change", ".cp-catalog-ammo-load", "", null, null],
  ["module/shop/catalog.js:886", "_activateRowChoices", "shop-catalog", "change", ".cp-cat-price b", "", null, null],
  ["module/shop/catalog.js:896", "_activateRowChoices", "shop-catalog", "change", ".cp-catalog-style", "", "the style picker paints only on fashion rows (r.fashion) in the catalog view — the windowed opening paint's rows hold none", null],
  ["module/shop/catalog.js:914", "_activateBuyerPick", "shop-catalog", "change", ".cp-buyer-pick", "", null, null],
  ["module/shop/catalog.js:992", "activateListeners", "shop-catalog", "click", ".cp-shop-back", "", null, null],
  ["module/shop/catalog.js:995", "activateListeners", "shop-home", "click", ".cp-home-catalog", "", null, null],
  ["module/shop/catalog.js:996", "activateListeners", "shop-storefront", "click", ".cp-shop-manage", "", null, null],
  ["module/shop/catalog.js:1000", "activateListeners", "shop-home", "click", ".cp-home-shop", "shopId", null, null],
  ["module/shop/catalog.js:1004", "activateListeners", "shop-home", "click", ".cp-home-create", "", null, null],
  ["module/shop/catalog.js:1014", "activateListeners", "shop-home", "contextmenu", ".cp-home-shop", "shopId", null, null],
  ["module/shop/catalog.js:1017", "activateListeners", "shop-catalog", "click", ".cp-shop-missing-back", "", "the dead-end panel renders only for a view whose shop has been deleted under it — driven end to end by the shop-drawer suite", null],
  ["module/shop/catalog.js:1020", "activateListeners", "shop-catalog", "input", ".cp-catalog-search", "", null, null],
  ["module/shop/catalog.js:1027", "activateListeners", "shop-catalog", "change", ".cp-catalog-showsource", "", null, null],
  ["module/shop/catalog.js:1035", "activateListeners", "shop-catalog", "click", ".cp-drawer-clear", "", "the clear control renders only while a filter is active — driven end to end by the shop-drawer suite", null],
  ["module/shop/catalog.js:1047", "activateListeners", "shop-catalog", "click", ".cp-jump", "letter", null, null],
  ["module/shop/catalog.js:1047", "activateListeners", "shop-catalog", "click", ".cp-catalog-list", "", null, null],
  ["module/shop/catalog.js:1058", "activateListeners", "shop-catalog", "click", ".cp-drawer-toggle", "", null, null],
  ["module/shop/catalog.js:1058", "activateListeners", "shop-catalog", "click", ".cp-filter-drawer", "open", null, null],
  ["module/shop/catalog.js:1073", "activateListeners", "shop-catalog", "click", ".cp-cat-expand", "cat", null, null],
  ["module/shop/catalog.js:1073", "activateListeners", "shop-catalog", "click", "i", "", null, null],
  ["module/shop/catalog.js:1097", "activateListeners", "shop-catalog", "change", ".cp-src-toggle", "source", null, null],
  ["module/shop/catalog.js:1124", "_activateRowControls", "shop-catalog", "click", ".cp-cat-itemname, .cp-cat-thumb", "", null, null],
  ["module/shop/catalog.js:1124", "_activateRowControls", "shop-catalog", "click", "[data-item-id], [data-source-key]", "", null, null],
  ["module/shop/catalog.js:1133", "_activateRowControls", "shop-catalog", "click", ".cp-catalog-buy", "", null, null],
  ["module/shop/catalog.js:1133", "_activateRowControls", "shop-catalog", "click", "[data-ammo-caliber], [data-item-id], [data-source-key]", "ammoCaliber,curated,itemId,packId,sourceKey", null, "ANY:ammoCaliber,itemId,sourceKey"],
  ["module/shop/catalog.js:1159", "_activateRowControls", "shop-catalog", "click", ".cp-list-items .cp-shop-add", "", "the ＋ add-to-shop control paints only under the build view's {{#if @root.isBuild}} branch — the catalog view paints Buy in its place", null],
  ["module/shop/catalog.js:1159", "_activateRowControls", "shop-catalog", "click", "[data-source-key]", "sourceKey", null, null],
  ["module/shop/catalog.js:1332", "_activateEyePaint", "shop-catalog", "pointerdown", ".cp-book-eye", "", null, null],
  ["module/shop/catalog.js:1332", "_activateEyePaint", "shop-catalog", "pointerdown", ".cp-src-toggle", "", null, null],
  ["module/shop/catalog.js:1340", "_activateEyePaint", "shop-catalog", "pointermove", ".cp-book-eye", "", null, null],
  ["module/shop/catalog.js:1342", "_activateEyePaint", "shop-catalog", "pointerup", ".cp-book-eye", "", null, null],
  ["module/shop/catalog.js:1343", "_activateEyePaint", "shop-catalog", "pointercancel", ".cp-book-eye", "", null, null],
  ["module/shop/catalog.js:1344", "_activateEyePaint", "shop-catalog", "click", ".cp-book-eye", "", null, null],
  ["module/shop/catalog.js:1365", "_activatePurchaseDrag", "shop-catalog", "dragstart", ".cp-catalog-list .cp-catalog-row[data-source-key]", "", null, null],
  ["module/shop/catalog.js:1396", "_activateListWindow", "shop-catalog", "scroll", ".cp-catalog-list", "", null, null],
  ["module/shop/catalog.js:1540", "_activateSetupMode", "shop-build", "click", ".cp-shop-setup-toggle", "", null, null],
  ["module/shop/catalog.js:1576", "_openContextMenu", "shop-contextmenu", "click", "button[data-action]", "action", null, null],
  ["module/shop/catalog.js:1621", "_activateBuildControls", "shop-build", "click", ".cp-shop-remove", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1621", "_activateBuildControls", "shop-build", "click", ".cp-bulk-add", "", null, null],
  ["module/shop/catalog.js:1638", "_activateBuildControls", "shop-build", "click", ".cp-vendor-clear", "", "the vendor tray's clear renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1651", "_activateBuildControls", "shop-build", "change", ".cp-shop-price", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1654", "_activateBuildControls", "shop-build", "change", ".cp-shop-stock-qty", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1662", "_activateBuildControls", "shop-build", "click", ".cp-shop-inf", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1668", "_activateBuildControls", "shop-build", "click", ".cp-stockall-apply", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1668", "_activateBuildControls", "shop-build", "click", ".cp-stockall-qty", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1675", "_activateBuildControls", "shop-build", "click", ".cp-stockall-inf", "", "the bulk-stock strip renders only for a shop holding lines", null],
  ["module/shop/catalog.js:1682", "_activateBuildControls", "shop-build", "change", ".cp-shop-style", "", "per-stocked-line control — the fixture shop's stocking did not take", null],
  ["module/shop/catalog.js:1682", "_activateBuildControls", "shop-build", "change", ".cp-shop-name", "", null, null],
  ["module/shop/catalog.js:1685", "_activateBuildControls", "shop-build", "change", ".cp-shop-open", "", null, null],
  ["module/shop/catalog.js:1686", "_activateBuildControls", "shop-build", "change", ".cp-shop-fullsearch", "", null, null],
  ["module/shop/catalog.js:1687", "_activateBuildControls", "shop-build", "change", ".cp-shop-discount", "", null, null],
  ["module/shop/catalog.js:1688", "_activateBuildControls", "shop-build", "change", ".cp-shop-notes", "", null, null],
  ["module/shop/catalog.js:1689", "_activateBuildControls", "shop-build", "click", ".cp-shop-announce", "", null, null],
  ["module/shop/catalog.js:1693", "_activateBuildControls", "shop-build", "click", ".cp-shop-preview", "", null, null],
  ["module/shop/catalog.js:1694", "_activateBuildControls", "shop-build", "click", ".cp-shop-delete", "", null, null],
  ["module/shop/catalog.js:1704", "_activateBuildControls", "shop-build", "dragover", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:1705", "_activateBuildControls", "shop-build", "dragleave", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:1706", "_activateBuildControls", "shop-build", "drop", ".cp-vendor-tray", "", null, null],
  ["module/shop/catalog.js:2106", "injectSidebarShopButton", "sidebar", "click", ".ui-control.plain.icon.fa-solid.fa-cart-shopping.cp-shop-tab", "", null, null],
  ["module/shop/catalog.js:2160", "_wireShopCardControls", "chat-card", "click", ".cp-shop-open-link", "shopId", null, null],
  ["module/shop/catalog.js:2167", "_wireShopCardControls", "chat-card", "click", ".cp-shop-request-btn", "action", null, null],
  ["module/shop/catalog.js:2167", "_wireShopCardControls", "chat-card", "click", ".cp-shop-request", "", null, null],
  ["module/shop/catalog.js:2167", "_wireShopCardControls", "chat-card", "click", ".cp-shop-request-price", "", null, null],
  ["module/item/item-sheet.js:885", "_cpActivateArmorRestoreControl", "item-sheet:any", "click", ".cp-armor-restore", "", "renders only on a pack-sourced armor item viewed by a GM (parseCompendiumSource must resolve) — the fixture item is not one", null],
  ["module/item/item-sheet.js:899", "_cpActivateMechConsumableControls", "item-sheet:consumable", "click", ".cp-consumable-use", "", null, null],
  ["module/item/item-sheet.js:899", "_cpActivateMechConsumableControls", "item-sheet:consumable", "click", ".cp-drug-take", "", null, null],
  ["module/item/item-sheet.js:899", "_cpActivateMechConsumableControls", "item-sheet:consumable", "click", ".cp-drug-end", "", "the wear-off control renders only while the drug is active on a holder", null],
  ["module/item/item-sheet.js:899", "_cpActivateMechConsumableControls", "item-sheet:consumable", "click", ".cp-chip-choice-reset", "", "renders only for a chipware item holding a recorded choice", null],
  ["module/item/item-sheet.js:936", "_cpActivateVehicleDeployControls", "item-sheet:vehicle", "click", ".cp-vehicle-open", "actorId", "the open control renders only once the vehicle item has a deployed actor", null],
  ["module/item/item-sheet.js:936", "_cpActivateVehicleDeployControls", "item-sheet:vehicle", "click", ".cp-vehicle-deploy", "", "the deploy row renders only on an EDITABLE vehicle item sheet (⏪ its world feature gate retired 2026-08-29, settings-trim)", null],
  ["module/item/item-sheet.js:981", "_cpActivateVehicleFaceSelect", "item-sheet:any", "change", "select.cp-veh-face-select", "faceCurrent", "renders on a VEHICLE item sheet only (the handler returns early for any other item type) and only when the face strip asks for it — templates/actor/parts/vehicle-face.hbs gates the select on faceControl.show", null],
  ["module/item/item-sheet.js:1079", "_cpActivateTabs", "item-sheet:any", "click", ".sheet-tabs", "", null, null],
  ["module/item/item-sheet.js:1079", "_cpActivateTabs", "item-sheet:any", "click", "[data-tab]", "tab", null, null],
  ["module/item/item-sheet.js:1133", "_cpActivateBasicItemActions", "item-sheet:any", "click", ".item-roll", "", "ORPHAN: no template in the module OR the base system paints `.item-roll`; both bind a handler for it", null],
  ["module/item/item-sheet.js:1133", "_cpActivateBasicItemActions", "item-sheet:any", "click", ".humanity-cost-roll", "", "renders on a cyberware item's settings tab, not on the weapon sheet this surface opens", null],
  ["module/item/item-sheet.js:1372", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-stat", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1372", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-check", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1372", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-location", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1372", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-penalty", "", "the cyberware mechanics editor renders only for an item with a chosen cyberwareType", null],
  ["module/item/item-sheet.js:1372", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "change", "select.cw-add-mountpolicy", "", "ORPHAN: the MountPolicy add control is bound and its list read and written, but no template paints it", null],
  ["module/item/item-sheet.js:1374", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-stat", "", "renders per recorded stat entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1374", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-check", "", "renders per recorded check entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1374", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-skill", "", "renders per recorded skill entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1374", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-location", "", "renders per recorded location entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1374", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-penalty", "", "renders per recorded penalty entry on the cyberware mechanics editor", null],
  ["module/item/item-sheet.js:1374", "_cpActivateCyberwareBasicControls", "item-sheet:cyberware", "click", ".cw-remove-mount", "", "ORPHAN: the MountPolicy remove control is bound, but no template paints it", null],
  ["module/item/item-sheet.js:1546", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "click", ".cw-ms-trigger", "", null, null],
  ["module/item/item-sheet.js:1546", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "click", ".cw-ms", "", null, null],
  ["module/item/item-sheet.js:1546", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "click", ".cw-ms-menu", "", null, null],
  ["module/item/item-sheet.js:1548", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", ".cw-ms-menu input[type='checkbox']", "", null, null],
  ["module/item/item-sheet.js:1548", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", ".cw-ms", "path", null, null],
  ["module/item/item-sheet.js:1548", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", ".cw-ms-menu", "", null, null],
  ["module/item/item-sheet.js:1548", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", "input[type='checkbox']:checked", "", null, null],
  ["module/item/item-sheet.js:1548", "_cpActivateCyberwareMechanicTypeControls", "item-sheet:cyberware", "change", "input[value=\"Descriptive\"]", "", null, null],
  ["module/item/item-sheet.js:1704", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "input", "input[name='cw-skill-search'], input[name='cw-chip-skill-search']", "", "the skill-search boxes render only inside the cyberware mechanics editor (needs a chosen cyberwareType)", null],
  ["module/item/item-sheet.js:1706", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "change", "input[name='cw-skill-search'], input[name='cw-chip-skill-search']", "", "the skill-search boxes render only inside the cyberware mechanics editor (needs a chosen cyberwareType)", null],
  ["module/item/item-sheet.js:1707", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "mousedown", "input[name='cw-skill-search'], input[name='cw-chip-skill-search']", "", "the skill-search boxes render only inside the cyberware mechanics editor (needs a chosen cyberwareType)", null],
  ["module/item/item-sheet.js:1708", "_cpActivateCyberwareSkillSearchControls", "item-sheet:cyberware", "click", ".cw-remove-chipskill", "key", "renders per recorded ChipSkills entry", null],
  ["module/item/item-sheet.js:1992", "_cpActivateSkillItemControls", "item-sheet:skill", "change", "input[name=\"system.level\"], input[name=\"system.chipLevel\"], input[name=\"system.isChipped\"]", "", null, null],
  ["module/item/item-sheet.js:2184", "_cpActivateNumericCommaInputs", "item-sheet:any", "change", "input[type=\"number\"]", "", null, null],
  ["module/item/item-sheet.js:2203", "_cpActivateCyberwareInstall", "item-sheet:cyberware", "click", ".cyber-install", "", "the install control renders only for cyberware held by an actor with an install target", null],
  ["module/item/item-sheet.js:2230", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "click", ".cp-sv-add", "", null, null],
  ["module/item/item-sheet.js:2230", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "click", ".cp-sv-remove", "index", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/item-sheet.js:2258", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "change", ".cp-sv", "field", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/item-sheet.js:2258", "_cpActivateVehicleWeaponShellControls", "item-sheet:vehicleweapon", "change", ".cp-shellvar", "", "shell-variant rows render only for a weapon that defines shell variants", null],
  ["module/item/item-sheet.js:2281", "_cpActivateAmmoControls", "item-sheet:ammo", "change", "input.ammo-blast-mult", "index", "the blast-multiplier row renders only for blast-capable ammo", null],
  ["module/item/item-sheet.js:2281", "_cpActivateAmmoControls", "item-sheet:ammo", "change", "select.cp-ammo-modifier", "", null, null],
  ["module/item/item-sheet.js:2281", "_cpActivateAmmoControls", "item-sheet:ammo", "change", ".ammo-ms-menu input[type=checkbox]", "", null, null],
  ["module/item/item-sheet.js:2281", "_cpActivateAmmoControls", "item-sheet:ammo", "change", ".ammo-ms", "", null, null],
  ["module/item/item-sheet.js:2281", "_cpActivateAmmoControls", "item-sheet:ammo", "change", ".ammo-ms-menu", "", null, null],
  ["module/item/item-sheet.js:2281", "_cpActivateAmmoControls", "item-sheet:ammo", "change", "input[type=checkbox]:checked", "", null, null],
  ...
  ["module/ip/tracker.js:134", "_onRender", "ip-tracker", "change", ".cp-ip-amount", "", null, null],
  ["module/ip/tracker.js:139", "_onRender", "ip-tracker", "keydown", ".cp-ip-amount", "", null, null],
  ["module/ip/tracker.js:139", "_onRender", "ip-tracker", "keydown", "[data-row-id]", "", null, null],
  ["module/ip/tracker.js:149", "_onRender", "ip-tracker", "change", ".cp-ip-success", "", "the success tick renders per queue row of a kind that records one; the seeded roll row does not", null],
  ["module/ip/tracker.js:156", "_onRender", "ip-tracker", "input", ".cp-ip-filter", "", null, null],
  ["module/ip/tracker.js:190", "_applyBalanceFilter", "ip-tracker", "change", ".cp-ip-bank", "", "the balances accordion paints skill rows only for an OPENED character block — the fixture's open click did not settle one", null],
  ["module/ip/tracker.js:190", "_applyBalanceFilter", "ip-tracker", "change", "[data-skill-id]", "actorId,skillId", "the balances accordion paints skill rows only for an OPENED character block — the fixture's open click did not settle one", null],
  ["module/ip/tracker.js:196", "_applyBalanceFilter", "ip-tracker", "change", ".cp-ip-pool", "actorId", "the balances accordion paints its pool field only for an opened character block", null],
  ["module/ip/tracker.js:357", "_manualAdd", "dialog:ip-manual", "change", "[name=\"actor\"]", "", null, null],
  ["module/ip/tracker.js:207", "_onApply", "ip-tracker", "click", "[data-action=\"ipApply\"]", "", null, null],
  ["module/ip/tracker.js:214", "_onClear", "ip-tracker", "click", "[data-action=\"ipClear\"]", "", null, null],
  ["module/ip/tracker.js:276", "_onOpenRow", "ip-tracker", "click", "[data-action=\"ipOpenRow\"]", "rowId@[data-row-id]", null, null],
  ["module/ip/tracker.js:257", "_onOpenActor", "ip-tracker", "click", "[data-action=\"ipOpenActor\"]", "actorId@.cp-ip-bal-block", null, null],
  ["module/ip/tracker.js:287", "_onPruneRoll", "ip-tracker", "click", "[data-action=\"ipPruneRoll\"]", "rollId@[data-roll-id],rowId@[data-row-id]", null, null],
  ["module/ip/tracker.js:228", "_onReset", "ip-tracker", "click", "[data-action=\"ipReset\"]", "", null, null],
  ["module/ip/tracker.js:233", "_onManual", "ip-tracker", "click", "[data-action=\"ipManual\"]", "", null, null],
  ["module/ip/tracker.js:237", "_onAward", "ip-tracker", "click", "[data-action=\"ipAward\"]", "", null, null],
  ["module/ip/tracker.js:268", "_onSkip", "ip-tracker", "click", "[data-action=\"ipSkip\"]", "rowId@[data-row-id]", null, null],
  ...
  ["module/dialog/automation-notice.js:93", "_onRender", "dialog:automation-notice", "change", ".cp-notice-hide", "", null, null],
  ["module/dialog/automation-notice.js:123", "_onPrev", "dialog:automation-notice", "click", "[data-action=\"noticePrev\"]", "", null, null],
  ["module/dialog/automation-notice.js:127", "_onNext", "dialog:automation-notice", "click", "[data-action=\"noticeNext\"]", "", null, null],
  ["module/dialog/automation-notice.js:132", "_onOpenSettings", "dialog:automation-notice", "click", "[data-action=\"noticeSettings\"]", "", null, null],
  ...
  ["module/combat/DamageDialog.js:299", "_onRender", "dialog:damage", "change", "select[name='armorMode']", "", null, null],
  ["module/combat/DamageDialog.js:305", "_onRender", "dialog:damage", "change", "select[name='damageType']", "", null, null],
  ["module/combat/DamageDialog.js:311", "_onRender", "dialog:damage", "change", "input[name='coverSP']", "", null, null],
  ["module/combat/DamageDialog.js:318", "_onRender", "dialog:damage", "change", "input[name='ablate']", "", null, null],
  ["module/combat/DamageDialog.js:325", "_onRender", "dialog:damage", "change", "input.after-sp-override", "hitIndex", null, null],
  ["module/combat/DamageDialog.js:423", "_onApply", "dialog:damage", "click", "[data-action=\"applyDamage\"]", "", null, null],
  ["module/combat/DamageDialog.js:587", "_onChewCoverOnly", "dialog:damage", "click", "[data-action=\"chewCoverOnly\"]", "", "renders only when the shot's line crossed a cover OBJECT, and only until it is pressed — a hand-opened window has no line to test and a typed Cover SP names no document to debit", null],
  ["module/combat/DamageDialog.js:610", "_onCancel", "dialog:damage", "click", "[data-action=\"cancelDialog\"]", "", null, null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "chat-card", "click", ".cp-suppression-evasion-roll", "actorId,attackerId,dmgFormula,saveDc,sceneId,tokenId", "renders on a suppressive-fire card, one row per defender caught in the lane", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "chat-card", "click", ".cp-suppressive-unlock", "regionId,sceneId", "renders on a placed suppressive-lane card, GM only", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "chat-card", "click", ".cp-confirm-explosion", "templateId", "renders on an explosion card, which needs a fired blast weapon", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "chat-card", "click", ".cp-confirm-spread-zone", "templateId", "renders on a spread/pattern card, which needs a fired shotgun or gas round", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "chat-card", "click", ".cp-clear-spread-zone", "templateId", "renders on the same pattern card as its voiding exit", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "combat-tracker", "click", ".cp-take-aim-btn", "", "the tracker paints these per combatant only during a LIVE combat the user controls — the census starts no combat and places no combatants", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "combat-tracker", "click", ".cp-wait-for-turn-btn", "combatantId", "as above, and only on the combatant whose turn is current", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "combat-tracker", "click", ".cp-wait-act-btn", "combatantId", "as above, and only on a combatant already flagged waitingForTurn", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "combat-tracker", "click", ".cp-dodge-btn", "", "as above, and only while the declared-defense feature is on", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "combat-tracker", "click", ".cp-parry-btn", "", "as above, and only while the declared-defense feature is on", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "combat-tracker", "click", ".cp-add-action-btn", "", "as above, and only while multi-action tracking is on", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "combat-tracker", "click", ".cp-manual-tick-btn", "", "as above, and only while manual round-ticking is on", null],
  ["module/combat/damage-hooks.js:334", "onGlobalClick", "chat-card", "click", "[data-message-id]", "", "the card wrapper each of the above resolves through — present only once one of those cards is posted", null],
  ["module/combat/damage-hooks.js:821", "_injectApplyDamageControl", "chat-card", "click", ".cp2020-apply-damage-btn", "", "injected only onto a card carrying an areaDamages payload, for a GM or the attacker's owner", null],
  ["module/combat/cover.js:1047", "onGlobalClick", "chat-card", "click", ".cp-cover-repair", "wallUuid", "renders on a cover-DESTRUCTION card and only for a wall that BREACHED — needs a valued wall shot to zero structure; GM-only by render gate", null],
  ["module/combat/cover.js:1290", "openCoverPlacementDialog", "cover-place-dialog", "change", "select[name=\"cp-cover-preset\"]", "", "the Place Cover dialog opens from a GM scene-control button; the census opens no scene controls", null],
  ["module/combat/cover.js:1456", "registerCoverWallConfig", "wall-config", "click", ".cp-cover-wall-clear", "", "renders inside the NATIVE Wall configuration sheet, which the census does not open", null],
  ["module/combat/cover.js:1477", "registerCoverWallConfig", "wall-config", "click", ".cp-cover-wall-repair", "", "same sheet, and only while that wall is currently breached", null],
  ["module/vehicle/vehicle-weapons.js:485", "openVehicleFireDialog", "dialog:vehicle-fire", "change", "#cp-vf-gunner", "", null, null],
  ["module/vehicle/vehicle-weapons.js:494", "openVehicleFireDialog", "dialog:vehicle-fire", "change", "#cp-vf-shell", "", null, null],
  ["module/vehicle/vehicle-weapons.js:501", "openVehicleFireDialog", "dialog:vehicle-fire", "change", "#cp-vf-rofmode", "", null, null],
  ["module/vehicle/vehicle-weapons.js:679", "onGlobalClick", "chat-card", "click", ".cp-vfire-apply", "ap,dmg,facing,gs,hda,heat,hef,pen,range,rg,rounds,weapon", "renders on a vehicle-fire card — needs a mounted weapon fired at a target", null],
  ["module/vehicle/vehicle-control.js:410", "openControlRollDialog", "dialog:vehicle-control", "change", "#cp-ctl-driver", "", null, null],
  ["module/vehicle/vehicle-control.js:411", "openControlRollDialog", "dialog:vehicle-control", "change", "#cp-ctl-skillkey", "", null, null],
  ["module/vehicle/vehicle-control.js:412", "openControlRollDialog", "dialog:vehicle-control", "change", "#cp-ctl-difficulty", "", null, null],
...
// ═════════════════════════════════════════════════════════════════════════════════════════════
const MANUAL_REVIEW = [
  ["module/actor/actor-sheet.js:373","_cpActivateStatusStrip","character-sheet","addEventListener(\"toggle\") on `root` — no literal selector at the registration"],
  ["module/actor/actor-sheet.js:655","$","character-sheet","addEventListener(\"dragstart\") on `node` — no literal selector at the registration"],
  ["module/actor/actor-sheet.js:662","$","character-sheet","addEventListener(\"dragend\") on `node` — no literal selector at the registration"],
  ["module/actor/actor-sheet.js:1731","bindHideListeners","character-sheet","addEventListener(\"DYNAMIC\") on `for (const e of HIDE_EVENTS) doc` — no literal selector at the registration"],
  ["module/actor/actor-sheet.js:3015","_activateTabTearOff","character-sheet","addEventListener(\"click\") on `nav` — no literal selector at the registration"],
  ["module/actor/actor-sheet.js:3141","_activateGearDragSort","character-sheet","addEventListener(\"drop\") on `list` — no literal selector at the registration"],
  ["module/actor/actor-sheet.js:3971","_cpSetupNotesAutosave","character-sheet","addEventListener(\"DYNAMIC\") on `root` — no literal selector at the registration"],
  ["module/shop/catalog.js:1047","activateListeners","shop-catalog","selector built from a template literal"],
  ["module/shop/catalog.js:1073","activateListeners","shop-catalog","selector built from a template literal"],
  ["module/shop/catalog.js:1242","_activateFilterPaint","shop-catalog","addEventListener(\"pointerdown\") on `btn` — no literal selector at the registration"],
  ["module/shop/catalog.js:1259","_activateFilterPaint","shop-catalog","addEventListener(\"pointermove\") on `root` — no literal selector at the registration"],
  ["module/shop/catalog.js:1261","_activateFilterPaint","shop-catalog","addEventListener(\"pointerup\") on `btn` — no literal selector at the registration"],
  ["module/shop/catalog.js:1262","_activateFilterPaint","shop-catalog","addEventListener(\"pointercancel\") on `btn` — no literal selector at the registration"],
  ["module/shop/catalog.js:1263","_activateFilterPaint","shop-catalog","addEventListener(\"click\") on `btn` — no literal selector at the registration"],
  ["module/shop/catalog.js:1277","_activateFilterPaint","shop-catalog","addEventListener(\"pointerup\") on `root` — no literal selector at the registration"],
  ["module/shop/catalog.js:1278","_activateFilterPaint","shop-catalog","addEventListener(\"pointercancel\") on `root` — no literal selector at the registration"],
  ["module/shop/catalog.js:1351","_activateEyePaint","shop-catalog","addEventListener(\"pointerup\") on `root` — no literal selector at the registration"],
  ["module/shop/catalog.js:1352","_activateEyePaint","shop-catalog","addEventListener(\"pointercancel\") on `root` — no literal selector at the registration"],
  ["module/item/item-sheet.js:1805","_cpActivateCyberwareSyncControls","item-sheet:cyberware","addEventListener(\"change\") on `root` — no literal selector at the registration"],
  ["module/item/item-sheet.js:2571","_cpSetupNotesAutosave","item-sheet:any","addEventListener(\"DYNAMIC\") on `root` — no literal selector at the registration"],
  ["module/dialog/modifiers.js:601","updateVisibility","dialog:modifiers","addEventListener(\"change\") on `fireModeEl` — no literal selector at the registration"],
  ["module/dialog/modifiers.js:602","updateVisibility","dialog:modifiers","addEventListener(\"change\") on `dualWieldEl` — no literal selector at the registration"],
  ["module/dialog/modifiers.js:604","updateVisibility","dialog:modifiers","addEventListener(\"DYNAMIC\") on `autoRoundsEl` — no literal selector at the registration"],
  ["module/dialog/modifiers.js:606","updateVisibility","dialog:modifiers","addEventListener(\"DYNAMIC\") on `numberInput(name)` — no literal selector at the registration"],
  ["module/combat/cover.js:1247","applyCoverDataToRegion","ui-notification","addEventListener(\"click\") on `el` — no literal selector at the registration"],
  ["module/combat/cover.js:1450","registerCoverWallConfig","wall-config","addEventListener(\"change\") on `spIn` — no literal selector at the registration"],
...
// ═════════════════════════════════════════════════════════════════════════════════════════════
const NON_DOM = [
  ["module/actor/actor-sheet.js:3011","doc.addEventListener(\"pointermove\") — gesture continuation","_activateTabTearOff"],
  ["module/actor/actor-sheet.js:3012","doc.addEventListener(\"pointerup\") — gesture continuation","_activateTabTearOff"],
  ["module/actor/actor-sheet.js:3013","doc.addEventListener(\"pointercancel\") — gesture continuation","_activateTabTearOff"],
  ["module/npcgen/npcgen-app.js:779","Hooks.on(\"renderActorDirectory\")","registerGoonCountMemory"],
  ["module/shop/catalog.js:1581","doc.addEventListener(\"click\") — gesture continuation","setTimeout"],
  ["module/shop/catalog.js:2208","Hooks.on(\"renderSidebar\")","registerShopHooks"],
  ["module/shop/catalog.js:2218","Hooks.on(\"controlToken\")","registerShopHooks"],
  ["module/shop/catalog.js:2237","game.socket.on(\"module.cp2020-augmented\")","onChatCardRender"],
  ["module/shop/catalog.js:2246","Hooks.on(\"dropActorSheetData\")","onChatCardRender"],
  ["module/item/item-sheet.js:1062","root.ownerDocument.addEventListener(\"click\") — gesture continuation","_cpActivateVehicleSpeedControls"],
  ["module/item/item-sheet.js:1549","root.ownerDocument.addEventListener(\"click\") — gesture continuation","_cpActivateCyberwareMechanicTypeControls"],
  ["module/item/item-sheet.js:1946","Hooks.on(\"updateItem\")","_cpActivateCyberwareSiblingRefresh"],
  ["module/combat/damage-hooks.js:569","Hooks.on(\"cyberpunk2020.weaponFired\")","_hookWeaponFired"],
  ["module/combat/damage-hooks.js:730","Hooks.on(\"createChatMessage\")","_hookCreateChatMessage"],
  ["module/combat/damage-hooks.js:780","Hooks.on(\"DYNAMIC\")","_hookDamageDialogDismissed"],
  ["module/combat/damage-hooks.js:933","Hooks.on(\"cyberpunk2020.suppressiveFire\")","_hookSuppressiveFire"],
  ["module/combat/damage-hooks.js:1126","Hooks.on(\"DYNAMIC\")","_hookSuppressiveZoneEntered"],
  ["module/combat/damage-hooks.js:1158","Hooks.on(\"updateCombat\")","_hookSuppressiveExpiry"],
  ["module/combat/damage-hooks.js:1338","Hooks.on(\"renderCombatTracker\")","_hookAimTracking"],
  ["module/combat/damage-hooks.js:1368","Hooks.on(\"renderModifiersDialog\")","_hookAimTracking"],
  ["module/combat/damage-hooks.js:1379","Hooks.on(\"cyberpunk2020.weaponFired\")","_hookAimTracking"],
  ["module/combat/damage-hooks.js:1409","Hooks.on(\"renderCombatTracker\")","_hookWaitForTurn"],
  ["module/combat/damage-hooks.js:1446","Hooks.on(\"updateCombat\")","_hookWaitForTurn"],
  ["module/combat/damage-hooks.js:1510","Hooks.on(\"renderCombatTracker\")","_hookDodgeParry"],
  ["module/combat/damage-hooks.js:1554","Hooks.on(\"updateCombat\")","_hookDodgeParry"],
  ["module/combat/damage-hooks.js:1604","Hooks.on(\"renderModifiersDialog\")","_hookDeclaredDefensePrefill"],
  ["module/combat/damage-hooks.js:1664","Hooks.on(\"updateCombat\")","_hookDotEffects"],
  ["module/combat/damage-hooks.js:1941","Hooks.on(\"cyberpunk2020.weaponFired\")","_hookGasCloud"],
  ["module/combat/damage-hooks.js:2063","Hooks.on(\"updateCombat\")","_hookGasCloudPerTurn"],
  ["module/combat/damage-hooks.js:2236","Hooks.on(\"renderCombatTracker\")","_hookManualRoundTick"],
  ["module/combat/damage-hooks.js:2493","Hooks.on(\"cyberpunk2020.weaponFired\")","_hookExplosion"],
  ["module/combat/damage-hooks.js:3243","Hooks.on(\"cyberpunk2020.weaponFired\")","_hookSpread"],
  ["module/combat/damage-hooks.js:4195","Hooks.on(\"updateCombat\")","_hookSpreadZoneExpiry"],
  ["module/combat/damage-hooks.js:4206","Hooks.on(\"DYNAMIC\")","_hookSpreadZoneExpiry"],
  ["module/combat/damage-hooks.js:4225","Hooks.on(\"canvasReady\")","_hookSpreadZoneExpiry"],
  ["module/combat/damage-hooks.js:4311","Hooks.on(\"renderCombatTracker\")","_hookMultiActionPenalty"],
  ["module/combat/damage-hooks.js:4359","Hooks.on(\"renderModifiersDialog\")","_hookMultiActionPenalty"],
  ["module/combat/damage-hooks.js:4405","Hooks.on(\"cyberpunk2020.weaponFired\")","else"],
  ["module/combat/damage-hooks.js:4430","Hooks.on(\"updateCombat\")","_incrementActionCount"],
  ["module/combat/damage-hooks.js:4437","Hooks.on(\"combatStart\")","_incrementActionCount"],
  ["module/combat/damage-hooks.js:4501","Hooks.on(\"updateActor\")","_hookLiveSheetUpdate"],
  ["module/combat/damage-hooks.js:4505","Hooks.on(\"updateItem\")","_hookLiveSheetUpdate"],
  ["module/combat/damage-hooks.js:4532","game.socket.on(\"module.cp2020-augmented\")","_hookSocketRelay"],
  ["module/combat/cover.js:1026","game.socket.on(\"DYNAMIC\")","registerCoverSocket"],
  ["module/combat/cover.js:1159","Hooks.on(\"canvasTearDown\")","_ensureArmTearDown"],
  ["module/combat/cover.js:1207","Hooks.on(\"createRegion\")","_ensureArmTearDown"],
  ["module/combat/cover.js:1284","Hooks.on(\"renderDialogV2\")","openCoverPlacementDialog"],
  ["module/combat/cover.js:1367","Hooks.on(\"getSceneControlButtons\")","registerCoverTools"],
  ["module/combat/cover.js:1394","Hooks.on(\"renderWallConfig\")","registerCoverWallConfig"],
  ["module/vehicle/vehicle-weapons.js:521","Hooks.on(\"updateToken\")","openVehicleFireDialog"],
  ...
  ["module/vehicle/vehicle-acpa-combat.js:258","Hooks.on(\"updateActor\")","wrapAcpaRollData"],
];
...
function surfaceOf(rel, fn, sel = "") {
  ...
  switch (rel) {
    ...
    // Cover wires four homes from one file, none of them a surface the census opens: the repair
    // button is delegated from the global click handler onto a destruction chat card; the preset
    // select lives in the Place Cover DialogV2; the clear/repair buttons and the SP field are
    // injected into core's own Wall configuration sheet; the arming notice's click-to-cancel sits
    // on a ui.notifications element. Before 2026-09-15 these surfaces were hand-typed into the
    // manifest and the first --refresh after the file grew reset all four to "unknown".
    case "module/combat/cover.js":
      if (/^\.cp-cover-repair$/.test(sel)) return "chat-card";
      if (fn === "openCoverPlacementDialog" || /cp-cover-preset/.test(sel)) return "cover-place-dialog";
      if (fn === "registerCoverWallConfig" || /cp-cover-wall-/.test(sel)) return "wall-config";
      if (fn === "applyCoverDataToRegion") return "ui-notification";
      return "unknown";
...
function extractFile(rel) {
  // LINE ENDINGS ARE NOT SOURCE (2026-09-15). The repo has no .gitattributes and autocrlf is on, so a
  // checkout can hand this reader CRLF files beside LF ones (the 09-01 rebase did exactly that to a dozen
  // module files). Every grammar below anchors on a brace followed by a bare line feed - on a CRLF file
  // the actions-map grammar matched NOTHING and all 16 vehicle-sheet rows read as "vanished" for two
  // weeks while the controls worked. The extractor reads LF whatever the checkout wrote; line numbers
  // are unaffected (one line break per line either way).
  ...
  if (am) {
    for (const [, key, ref] of am[1].matchAll(/([\w$]+)\s*:\s*([\w$.]+)\s*,/g)) {
      ...
      if (hIdx >= 0) {
        ...
        // `const row = target.closest("[data-row-id]"); row.dataset.rowId` — the field lives on
        // the ANCESTOR, not on the button the action selector matches, so the read is recorded as
        // `rowId@[data-row-id]` and measured there. Recording it bare put the census's first sight
        // of the IP tracker's actions map (2026-09-15, after the CRLF fix) on the button itself,
        // where it is legitimately empty, and reported a working accordion as dead data.
        ...
        while ((x = r4.exec(body))) {
          ...
          let y; while ((y = rr.exec(body))) reads.add(`${y[1]}@${unq(x[2])}`);
        }
        // The same read inline: `target.closest("[data-roll-id]")?.dataset?.rollId`.
        const r5 = new RegExp(`\\b${tv}\\??\\.closest\\s*\\??\\.?\\s*\\(\\s*${SELRE}\\s*\\)\\??\\.dataset\\??\\.(\\w+)`, "g");
        while ((x = r5.exec(body))) reads.add(`${x[2]}@${unq(x[1])}`);
      }
...
try {
  census = await p.evaluate(async ({ manifest, rendered }) => {
    ...
    let ipWas = null, throttleWas = null, pcId = null;   // ⏪ npcWas retired with npcGenEnabled 2026-08-28; shopWas with shoppingEnabled 2026-08-29
    ...
    try {
      ...
      const measure = (surface, root) => {
        for (const rec of acc.values()) {
          ...
          for (const f of (rec.reads ? rec.reads.split(",").filter(Boolean) : [])) {
            const at = f.indexOf("@");
            const name = at < 0 ? f : f.slice(0, at), anc = at < 0 ? "" : f.slice(at + 1);
            const vals = nodes.map(n => (anc ? n.closest(anc) : n)?.dataset?.[name]);
      ...
      await open("ip-tracker", async () => {
        ...
        // TWO rolls of the same skill, so the row GROUPS: the row opener and the per-roll prune
        // link are painted only for a grouped row (`{{#unless row.single}}`), and a single-roll
        // fixture reported both as unreachable (2026-09-15).
        try {
          const sk = pc.items.find(i => i.type === "skill");
          if (sk) {
            // Awaited one at a time: the recorder reads the queue synchronously and writes it
            // through an async world-setting update, so two un-awaited calls both read the
            // empty queue and the second REPLACES the first (earmark: same-tick queue race).
            await IP.recordSkillRoll({ actorId: pc.id, skillId: sk.id, total: 14 });
            await IP.recordSkillRoll({ actorId: pc.id, skillId: sk.id, total: 9 });
            await sleep(500);
          }
        } catch (e) { out.notes.push("ip queue seed: " + e.message); }
        // The throttle-reset button renders only while a throttle mode is on (default off).
        try {
          throttleWas = game.settings.get(SCOPE, "ipThrottle");
          if (throttleWas === "off") await game.settings.set(SCOPE, "ipThrottle", "hardcap");
        } catch {}
        ...
        await sleep(700);
        // Open the grouped row too, so the census measures the rolls list in its opened state.
        r?.querySelector("[data-action='ipOpenRow']")?.dispatchEvent(new MouseEvent("click", { bubbles: true }));
        await sleep(300);
        return rootOf(app);
      }, 300);
      ...
      for (const a of game.actors.filter(a => a.name.startsWith("__PW__CENSUS"))) await a.delete().catch(() => {});
      // Literal scope here: `SCOPE` is declared inside the try above and is NOT visible in this
      // finally — the first restore threw a silent ReferenceError and left the rig on "hardcap".
      if (throttleWas === "off") { try { await game.settings.set("cp2020-augmented", "ipThrottle", "off"); } catch {} }
