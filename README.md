...
**Current release: 1.2.5.** The module is in active use and updated as bugs are reported and rules gaps are found. Every release has notes on the [releases page](https://github.com/ryno4ever16/cp2020-augmented/releases), and updates arrive through Foundry's normal update check.
